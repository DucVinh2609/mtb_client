      ...
      <div class="banner">
        <ul>
          <li data-transition="fade" data-slotamount="7" class="slide" data-slide="Rush.">
            <img alt src="../assets/images/slides/first-slide.jpg" />
            <div
              class="caption slide__name margin-slider"
              data-x="right"
              data-y="80"
              data-splitin="chars"
            ...
            <div
              class="caption slide__time margin-slider sfr str"
              data-x="right"
              data-hoffset="-243"
              data-y="186"
              data-speed="300"
            ...
            >From</div>
            <div
              class="caption slide__date margin-slider lfb ltb"
              data-x="right"
              data-hoffset="-149"
              data-y="186"
              data-speed="500"
            ...
            >November 01</div>
            <div
              class="caption slide__text margin-slider customin customout"
              data-x="right"
              data-y="250"
              ...
              data-endeasing="Back.easeIn"
            >
              Two-time Academy Award winner Ron Howard, teams once again with fellow two-time Academy
              <br />Award nominee, writer Peter Morgan , on Rush, a spectacular big-screen re-creation of the merciless
              <br />1970s rivalry between James Hunt and Niki Lauda.
            </div>
            <div
              class="caption margin-slider skewfromright customout"
              data-x="right"
              data-y="324"
              data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
              data-speed="400"
          ...
          <li
            ...
            data-slide="Travel worldwide.
              Create trip film."
          >
            <img alt src="../assets/images/bg-video.jpg" />
            <div class="caption slide__video" data-x="0" data-y="0" data-autoplay="true">
              <video
                ...
                loop="loop"
                muted
                src="../assets/video/TravelIs.webm"
              >
                <source type="video/webm" src="../assets/video/TravelIs.webm" />
              </video>
            </div>

            <div
              class="caption slide__name slide__name--smaller"
              data-x="left"
              data-y="160"
              data-splitin="chars"
              data-elementdelay="0.1"
            ...
            <div
              class="caption lfb slider-wrap-btn ltb"
              data-x="left"
              data-y="310"
              data-speed="400"
              data-start="3300"
          ...
          <li
            ...
            data-slide="Stop wishing.
              Start doing."
          >
            <img alt src="../assets/images/slides/next-slide.jpg" />
            <div
            ...
            >
              Stop
              <span class="highlight">wishing.</span> Start
              <span class="highlight">doing.</span>
            </div>

            <div
              class="caption slide__descript customin customout"
              data-x="left"
              data-y="240"
              data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;"
              data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
              ...
              data-end="8400"
              data-endeasing="Back.easeIn"
            >find your best match movie with A.MOVIE</div>

            <div
              class="caption lfb customout slider-wrap-btn"
              data-x="left"
              data-y="310"
              data-speed="500"
              data-start="2800"
    ...
    <section class="container">
        ...
        <div class="col-sm-12 change--col">
          <div class="movie-beta__item">
            ...
            <ul class="movie-beta__info">
              <li>
                <span class="best-voted">71 people voted today</span>
              </li>
              <li>
          ...
          <div class="movie-beta__item second--item">
            <img alt src="../assets/images/movie/movie-sample2.jpg" />
            <span class="best-rate">5.0</span>
          ...
          <div class="movie-beta__item third--item">
            <img alt src="../assets/images/movie/movie-sample3.jpg" />
            <span class="best-rate">5.0</span>
          ...
          <div class="movie-beta__item hidden-xs">
            <img alt src="../assets/images/movie/movie-sample4.jpg" />
            <span class="best-rate">5.0</span>
          ...
          <div class="movie-beta__item hidden-xs hidden-sm">
            <img alt src="../assets/images/movie/movie-sample5.jpg" />
            <span class="best-rate">5.0</span>
          ...
          <div class="movie-beta__item hidden-xs hidden-sm">
            <img alt src="../assets/images/movie/movie-sample6.jpg" />
            <span class="best-rate">5.0</span>
        ...
        <div class="mega-select-present mega-select-top mega-select--full">
          <div class="mega-select-marker">
            ...
            <div class="marker-indecator actors">
              <p class="select-marker">
                <span>like particular stars</span>
                <br />find them
              </p>
            </div>
            ...
            <div class="marker-indecator director">
              <p class="select-marker">
                <span>admire personalities - find</span>
                <br />by director
              </p>
            </div>
            ...
            <div class="marker-indecator country">
              <p class="select-marker">
                <span>search for movie from certain</span>
                <br />country?
              </p>
            </div>
          </div>
          ...
          <div class="mega-select pull-right">
            ...
            <ul class="mega-select__sort">
              <li class="filter-wrap">
                <a
                  href="#"
                  class="mega-select__filter filter--active"
                  data-filter="location"
                >Location</a>
              </li>
              <li class="filter-wrap">
                <a href="#" class="mega-select__filter" data-filter="cinema">Cinema</a>
              </li>
              <li class="filter-wrap">
                <a href="#" class="mega-select__filter" data-filter="film-category">Category</a>
              </li>
              <li class="filter-wrap">
                <a href="#" class="mega-select__filter" data-filter="actors">Actors</a>
              </li>
              <li class="filter-wrap">
                <a href="#" class="mega-select__filter" data-filter="director">Director</a>
              </li>
              <li class="filter-wrap">
                <a href="#" class="mega-select__filter" data-filter="country">Country</a>
              </li>
            </ul>
            ...
            <div class="select__btn">
              <a href="#" class="btn btn-md btn--danger location">
                find
                <span class="hidden-exrtasm">your city</span>
              </a>
              <a href="#" class="btn btn-md btn--danger cinema">
                find
                <span class="hidden-exrtasm">suitable cimema</span>
              </a>
              <a href="#" class="btn btn-md btn--danger film-category">
                find
                <span class="hidden-exrtasm">best category</span>
              </a>
              <a href="#" class="btn btn-md btn--danger actors">
                find
                <span class="hidden-exrtasm">talented actors</span>
              </a>
              <a href="#" class="btn btn-md btn--danger director">
                find
                <span class="hidden-exrtasm">favorite director</span>
              </a>
              <a href="#" class="btn btn-md btn--danger country">
                find
                <span class="hidden-exrtasm">produced country</span>
              </a>
            </div>
        ...
        <div class="row">
          <div class="col-sm-8 col-md-9">
            ...
            <div class="movie movie--test movie--test--light movie--test--left">
              <div class="movie__images">
                <a href="movie-page-left.html" class="movie-beta__link">
                  <img alt src="../assets/images/movie/movie-time1.jpg" />
                </a>
              </div>

              <div class="movie__info">
                <a
                  href="movie-page-left.html"
                  class="movie__title"
            ...
            <div class="movie movie--test movie--test--light movie--test--right">
              <div class="movie__images">
                <a href="movie-page-left.html" class="movie-beta__link">
                  <img alt src="../assets/images/movie/movie-time9.jpg" />
                </a>
              </div>
              ...
              <div class="movie__info">
                <a
                  href="movie-page-left.html"
                  class="movie__title"
                >The Hunger Games: Catching Fire (2013)</a>
            ...
            <div class="movie movie--test movie--test--dark movie--test--right">
              <div class="movie__images">
                <a href="movie-page-left.html" class="movie-beta__link">
                  <img alt src="../assets/images/movie/movie-time10.jpg" />
                </a>
              </div>
            ...
            <div class="movie movie--test movie--test--dark movie--test--left">
              <div class="movie__images">
                <a href="movie-page-left.html" class="movie-beta__link">
                  <img alt src="../assets/images/movie/movie-time11.jpg" />
                </a>
              </div>
            ...
            <div class="movie movie--test movie--test--light movie--test--left">
              <div class="movie__images">
                <a href="movie-page-left.html" class="movie-beta__link">
                  <img alt src="../assets/images/movie/movie-time12.jpg" />
                </a>
              </div>
            ...
            <div class="movie movie--test movie--test--light movie--test--right">
              <div class="movie__images">
                <a href="movie-page-left.html" class="movie-beta__link">
                  <img alt src="../assets/images/movie/movie-time13.jpg" />
                </a>
              </div>
            ...
            <div class="movie movie--test movie--test--dark movie--test--right">
              <div class="movie__images">
                <a href="movie-page-left.html" class="movie-beta__link">
                  <img alt src="../assets/images/movie/movie-time14.jpg" />
                </a>
              </div>
              ...
              <div class="social-group">
                <div class="col-sm-6 col-md-4 col-sm-push-6 col-md-push-4">
                  <div class="social-group__head">
                    Join
                    <br />our social groups
                  </div>
                  <div class="social-group__content">
                    A lot of fun, discussions, queezes and contests among members.
                    <br class="hidden-xs" />
                    <br />Always be first to know about best offers from cinemas and our partners
                  </div>
                </div>
          ...
          <aside class="col-sm-4 col-md-3">
            <div class="sitebar first-banner--left">
              <div class="banner-wrap first-banner--left">
                <img alt="banner" src="../assets/images/banners/sale.jpg" />
              </div>

              <div class="banner-wrap">
                <img alt="banner" src="../assets/images/banners/sport.jpg" />
              </div>

              <div class="banner-wrap banner-wrap--last">
                <img alt="banner" src="../assets/images/banners/boots.jpg" />
              </div>
                ...
                <div class="promo__content">
                  <ul>
                    <li class="store-variant">
                      <a href="#">
                        <img alt src="../assets/images/apple-store.svg" />
                      </a>
                    </li>
                    <li class="store-variant">
                      <a href="#">
                        <img alt src="../assets/images/google-play.svg" />
                      </a>
                    </li>
                    <li class="store-variant">
                      <a href="#">
                        <img alt src="../assets/images/windows-store.svg" />
                      </a>
                    </li>
                  </ul>
                </div>
      ...
      <div class="col-sm-12">
        ...
        <div class="col-sm-4 similar-wrap col--remove">
          <div class="post post--preview post--preview--wide">
            <div class="post__image">
              <img alt src="../assets/images/client-photo/post-thor.jpg" />
            ...
            <a
              ...
              class="post__title"
            >"Thor: The Dark World" - World Premiere</a>
        ...
        <div class="col-sm-4 similar-wrap col--remove">
          <div class="post post--preview post--preview--wide">
            <div class="post__image">
              <img alt src="../assets/images/client-photo/post-annual.jpg" />
              <div class="social social--position social--hide">
                <span class="social__name">Share:</span>
                <a href="#" class="social__variant social--first fa fa-facebook"></a>
                <a href="#" class="social__variant social--second fa fa-twitter"></a>
            ...
            <a
              href="single-page-left.html"
              class="post__title"
            >30th Annual Night Of Stars Presented By The Fashion Group International</a>
            <a href="single-page-left.html" class="btn read-more post--btn">read more</a>
          </div>
        </div>
        <div class="col-sm-4 similar-wrap col--remove">
          <div class="post post--preview post--preview--wide">
            <div class="post__image">
              <img alt src="../assets/images/client-photo/post-awards.jpg" />
              <div class="social social--position social--hide">
                <span class="social__name">Share:</span>
                <a href="#" class="social__variant social--first fa fa-facebook"></a>
                <a href="#" class="social__variant social--second fa fa-twitter"></a>
