      ...
      <div class="col-sm-12">
        <div class="checkout-wrapper">
          ...
          <ul class="book-result">
            ...
            <li class="book-result__item">
              Reservation fee:
              <span class="book-result__count">$3</span>
            </li>
            <li class="book-result__item">
              Total:
              <span class="book-result__count booking-cost">$69</span>
            </li>
          </ul>
          ...
          >Fill your contact information to recieve your reservation code. Reserved tickets are removed 20 minutes befor the session is due to start</p>
        </div>
