    ...
    <section class="container">
      <div class="col-sm-12">
        ...
        <div class="post">
          <div class="post__preview">
            <div class="swiper-container">
              <div class="swiper-wrapper">
                ...
                <div
                  class="swiper-slide"
                  data-text="Mauris gravida ipsum vitae libero eget dignissim ipsum egestas."
                >
                  <img alt src="../assets/images/client-photo/single-post.jpg" />
                </div>

                <!--Second Slide-->
                <div
                  class="swiper-slide"
                  data-text="Natalie Zea at Amazon Studios Launch Party for 'Alpha House' and 'Betas'"
                >
                  <img alt src="../assets/images/new/news-1.jpg" />
                </div>

                <!--Third Slide-->
                <div
                  class="swiper-slide"
                  data-text="Aliquam cursus porta porttitor. Donec faucibus risus vitae porta tincidunt."
                >
                  <img alt src="../assets/images/new/news-2.jpg" />
                </div>
              </div>
              <!-- end swiper wrapper-->
            </div>
            ...
            <a class="arrow-left no-hover" href="#">
              <span class="slider__info"></span>
            </a>
          ...
          <p>
            Mauris gravida ipsum vitae libero molestie eget dignissim ipsum egestas. Quisque in eros id velit molestie placerat a ut arcu. Etiam consequat, turpis ac commodo rhoncus, justo enim consequat tortor, vitae interdum odio tellus at sem. Aliquam lacus quam, lobortis sed lacus eget, commodo volutpat nunc.
            <a href="#" class="link--text">Text link sample</a>. Proin accumsan diam vel nulla ultrices congue.
          </p>

          <p>
            Phasellus at faucibus nisi. Nullam tincidunt sapien leo, et sodales mauris placerat vulputate. Ut pulvinar, dolor viverra pulvinar scelerisque, nisi tellus elementum libero, porta rutrum dui massa bibendum nisl. Donec viverra mi sit amet massa commodo, ullamcorper sollicitudin quam laoreet.
            <a href="#" class="link--text">Text link hover sample</a>. Aliquam cursus porta porttitor. Donec faucibus risus vitae porta tincidunt. Sed egestas elementum quam sed fermentum. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Quisque posuere suscipit tristique.
          </p>
          ...
          <div class="col-sm-12 col-md-6">
            <blockquote class="quote quote--intext">
              If it were easy,
              <br />everyone would do it.
              <small class="quote__author">
                <span class="quote__author-name">Loki, Thor: The Dark World</span>
              </small>
            </blockquote>
          </div>
          ...
          <p class="col-sm-6 text--coloum">
            <strong>Interdum et malesuada fames ac ante ipsum primis</strong> in faucibus. Quisque fermentum vel ipsum tincidunt interdum. Mauris sed nisi quis velit aliquam ultrices ac vel odio. Vivamus vehicula lacus eu nisl eleifend porta. Sed mollis quis felis et luctus. Quisque laoreet mauris condimentum dolor cursus, in condimentum massa volutpat. Vivamus vitae nisl pulvinar, luctus est eget, accumsan tellus.
          </p>

          <p class="col-sm-5 text--coloum">
            <strong>Nam pharetra sapien metus, in luctus massa</strong> dignissim id. Nam eu luctus eros, ac malesuada neque. Donec gravida orci sit amet turpis bibendum, nec imperdiet sem vehicula. Nullam viverra mauris eu lobortis tristique. Pellentesque quis fermentum orci. Nulla viverra viverra lorem in tincidunt. Maecenas quis cursus augue.
          </p>
          ...
          <div class="post__images post__images--right col-sm-6 pull-right">
            <img alt src="../assets/images/client-photo/post-img1.jpg" />
          </div>
          ...
          <div class="post__images post__images--left col-sm-6 pull-left">
            <img alt src="../assets/images/client-photo/post-img2.jpg" />
          </div>
          ...
          <div class="info-wrapper">
            <div class="tags">
              <ul>
                <li class="item-wrap">
                  <a href="#" class="tags__item">news</a>
                </li>
                <li class="item-wrap">
                  <a href="#" class="tags__item">movie</a>
                </li>
                <li class="item-wrap">
                  <a href="#" class="tags__item">ceremony</a>
                </li>
                <li class="item-wrap">
                  <a href="#" class="tags__item">award</a>
                </li>
              </ul>
            </div>
            <div class="share">
          ...
          <div class="comment-sets">
            <div class="comment">
              <div class="comment__images">
                <img alt src="../assets/images/comment/avatar.jpg" />
              </div>

              <a href="#" class="comment__author">
                <span class="social-used fa fa-facebook"></span>Roberta Inetti
              </a>
              <p class="comment__date">today | 03:04</p>
              <p
                class="comment__message"
              >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut vitae enim sollicitudin, euismod erat id, fringilla lacus. Cras ut rutrum lectus. Etiam ante justo, volutpat at viverra a, mattis in velit. Morbi molestie rhoncus enim, vitae sagittis dolor tristique et.</p>
              <a href="#" class="comment__reply">Reply</a>
            </div>

            <div class="comment">
              <div class="comment__images">
                <img alt src="../assets/images/comment/avatar-olia.jpg" />
              </div>

              <a href="#" class="comment__author">
                <span class="social-used fa fa-vk"></span>Olia Gozha
              </a>
            ...
            <div class="comment comment--answer">
              <div class="comment__images">
                <img alt src="../assets/images/comment/avatar-dmitriy.jpg" />
              </div>

              <a href="#" class="comment__author">
                <span class="social-used fa fa-vk"></span>Dmitriy Pustovalov
              </a>
            ...
            <div class="comment comment--last">
              <div class="comment__images">
                <img alt src="../assets/images/comment/avatar-sia.jpg" />
              </div>

              <a href="#" class="comment__author">
                <span class="social-used fa fa-facebook"></span>Sia Andrews
              </a>
